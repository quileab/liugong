...
new class extends Component
{
    ...
    public function updateProfileInformation(): void
    {
        ...
        $this->dispatch('profile-updated', name: $this->form->name);
    }
...
<section>
    ...
    <form wire:submit="updateProfileInformation" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input wire:model="form.email" id="email" name="email" type="email" class="mt-1 block w-full" required autocomplete="username" />
